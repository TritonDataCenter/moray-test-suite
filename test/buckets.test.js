    ...
    c.createBucket(b, cfg, function (err) {
        ...
        c.updateBucket(b, cfg, function (err2) {
            ...
            c.getBucket(b, function (err3, bucket) {
                t.ifError(err3);
                var count = 0;
                var res = c.sql('SELECT indexname FROM pg_indexes where indexname LIKE \'' + b + '_foo_idx\';');
    ...
    c.createBucket(b, cfg, function (err) {
        ...
        c.updateBucket(b, cfg, function (err2) {
            ...
            c.getBucket(b, function (err3, bucket) {
                t.ifError(err3);
                var count = 0;
                var res = c.sql('SELECT indexname FROM pg_indexes where indexname LIKE \'' + b + '_bar_idx\';');
                res.on('record', function (r) {
                    count += 1;
                });
                res.on('end', function () {
    ...
    c.createBucket(b, cfg, function (err) {
        ...
        c.updateBucket(b, cfg, function (err2) {
            ...
            c.getBucket(b, function (err3, bucket) {
                t.ifError(err3);
                var count = 0;
                var res = c.sql('SELECT indexname FROM pg_indexes where indexname LIKE \'' + b + '_baz_idx\';');
                res.on('record', function (r) {
                    count += 1;
                });
                res.on('end', function () {
    ...
    c.createBucket(b, cfg, function (err) {
        ...
        c.updateBucket(b, cfg, function (err2) {
            ...
            c.getBucket(b, function (err3, bucket) {
                t.ifError(err3);
                var count = 0;
                var res = c.sql('SELECT indexname FROM pg_indexes where indexname LIKE \'' + b + '_bee_idx\';');
                res.on('record', function (r) {
                    count += 1;
                });
                res.on('end', function () {
